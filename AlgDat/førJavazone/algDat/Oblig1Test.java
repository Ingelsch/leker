...
public class Oblig1Test
{
	public static void main(String[] args)
	{
		...
		{
			System.out.println("Dette mÂ forbedres. Du har minst " + antallFeil + " feil!");
		}
	}
	...
	public static int oppgave3()
	{
		...
		if (Oblig1.medlemsnummer() != 5100)
		{
			antallFeil++;
			System.out.println
					("Oppgave 3: Metoden gir feil svar!");
		}
	...
	public static int oppgave6()
	{
		...
		if (tid > 20)
		{
			System.out.println("Oppgave 6: i) Metoden "
					+ "er for ineffektiv. MÂ forbedres!");
			antallFeil++;
		}
	...
	public static int[] randPerm(int n)  // en effektiv versjon
	{
		...
		for (int k = n - 1; k > 0; k--)  // l¯kke som gÂr n - 1 ganger
		{
	...
	public static int oppgave8()
	{
		...
		do
		{
			...
			{
				System.out.println
						("Opgave 8: a) Indeks-metoden gj¯r endringer i tabellen!");
				antallFeil++;
			}
		...
		{
			System.out.println
					("Opgave 8: d) Det skal kastes unntak for tabeller med for fÂ verdier!");
			antallFeil++;
		}
		...
		{
			System.out.println
					("Oppgave 8: g) Metoden gj¯r endringer i tabellen!");
			System.out.println("Tabellen f¯r: " + Arrays.toString(y));
	...
	public static int oppgave9()
	{
		...
		{
			System.out.println
					("Oppgave 9: f) Metoden gj¯r endringer i koden!");
			antallFeil++;
		}
